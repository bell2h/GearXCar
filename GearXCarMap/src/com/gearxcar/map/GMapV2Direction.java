...
public class GMapV2Direction {
    ...
    public Document getDocument(LatLng start, LatLng end, String mode) {
        ...
        try {
            ...
            Log.e("Direction", "LO getDocument " + e.toString());
            e.printStackTrace();
        }
        return null;
    }
    ...
    public String getDurationText(Document doc) {
        try {
            ...
            Log.e("Direction", "LO getDurationText " + e.toString());
            return "0";
        }
    }
    ...
    public int getDurationValue(Document doc) {
        try {
            ...
            Log.e("Direction", "LO getDurationValue " + e.toString());
            return -1;
        }
    }
    ...
    public String getDistanceText(Document doc) {
        ...
        try {
            ...
            Log.e("Direction", "LO getDistanceText " + e.toString());
            return "-1";
        }
    ...
    public int getDistanceValue(Document doc) {
        try {
            ...
            Log.e("Direction", "LO getDistanceValue " + e.toString());
            return -1;
        }
        /*
    ...
    public String getStartAddress(Document doc) {
        try {
            ...
            Log.e("Direction", "LO getStartAddress " + e.toString());
            return "-1";
        }
    ...
    public String getEndAddress(Document doc) {
        try {
            ...
            Log.e("Direction", "LO getEndAddress " + e.toString());
            return "-1";
        }
    }
    public String getCopyRights(Document doc) {
        try {
            ...
            Log.e("Direction", "LO getCopyRights " + e.toString());
            return "-1";
        }
